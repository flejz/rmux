...
| [<img src="https://rmux.io/demos/demo-orchestration.png" width="150" alt="Multi Agents Orchestration demo preview">](https://rmux.io/#demo-orchestration)<br><sub>Multi Agents Orchestration</sub><br><sub><em>≃ 514 lines</em></sub> | [<img src="https://rmux.io/demos/demo-broadcast.png" width="150" alt="Agent Broadcast Arena demo preview">](https://rmux.io/#demo-broadcast)<br><sub>Agent Broadcast Arena</sub><br><sub><em>≃ 2,171 lines</em></sub> | [<img src="https://rmux.io/demos/demo-zellij.png" width="150" alt="Mini-Zellij demo preview">](https://rmux.io/#demo-zellij)<br><sub>Mini-Zellij</sub><br><sub><em>≃ 944 lines</em></sub> | [<img src="https://rmux.io/demos/demo-mirroring.png" width="150" alt="Terminal browser mirroring demo preview">](https://rmux.io/#demo-mirroring)<br><sub>Terminal &lt;&gt; Browser Mirroring</sub><br><sub><em>≃ 649 lines</em></sub> | [<img src="https://rmux.io/demos/demo-playwright.png" width="150" alt="Playwright Testing demo preview">](https://rmux.io/#demo-playwright)<br><sub>Playwright Testing</sub><br><sub><em>≃ 1,495 lines</em></sub> |
| --- | --- | --- | --- | --- |
